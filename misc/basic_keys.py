...
# Phonetic version
alpha_alt = 'alpha bravo charlie del echo foxtrot golf hotel india juliet kilo lima mike november oscar papa queen romeo sierra tango uni victor whiskey x-ray yankee zulu'.split()
