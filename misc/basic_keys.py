...
# Phonetic version
alpha_alt = 'alpha bravo charlie delta echo foxtrot golf hotel india juliet kilo lima mike november oscar papa quebec romoe sierra tango uniform victor whiskey x-ray yankee zulu'.split()
